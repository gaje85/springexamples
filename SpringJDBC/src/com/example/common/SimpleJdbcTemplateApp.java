...
import com.example.customer.dao.impl.CustomerDAO;
...
public class SimpleJdbcTemplateApp 
{
    public static void main( String[] args )
    {
        ...
        Customer customer4 = new Customer(4, "john4",24);
        Customer customer5 = new Customer(5, "john5",25);
        Customer customer6 = new Customer(6, "john6",26);
